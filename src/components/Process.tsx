          ...
          {steps.map((step, i) => (
            <Reveal key={step.number} delay={i * 100}>
              <div className="group relative flex h-full flex-col p-6 lg:px-6">
                {i < steps.length - 1 && (
                  <div className="absolute right-0 top-1/2 hidden h-px w-full -translate-y-1/2 bg-linear-to-r from-brand/40 to-transparent lg:block" aria-hidden="true" />
                )}

                <div className="relative">
                  <div className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br ${
