...
export default function Contact() {
	...
	return (
		<section id="contact" className="relative section overflow-hidden">
			<div
				className="absolute -bottom-40 left-1/2 h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-brand/10 blur-[140px]"
				aria-hidden="true"
			/>
				...
				<div className="mx-auto max-w-2xl text-center">
					...
					<Reveal delay={100}>
						<h2 className="mt-5 text-balance font-display text-4xl font-medium tracking-tight text-ink md:text-5xl">
							Let's talk about{" "}
							<span className="serif-accent text-brand-dark">your project</span>
							.
						</h2>
					</Reveal>
					<Reveal delay={200}>
						<p className="mt-5 text-lg text-ink-soft">
							Book a free consultation or send us a message. Tell us where
							you're based and what you need — we'll get back within 24 hours or
							less.
						</p>
					</Reveal>
				</div>
					...
					<Reveal>
						<div className="flex h-full flex-col gap-4">
							...
							{contactChannels.map((channel) => (
								<div
									key={channel.label}
									className="flex items-center gap-4 rounded-2xl border border-hairline bg-surface p-5 transition-colors hover:border-brand/30"
								>
							...
							{submitted ? (
								<div className="flex h-full flex-col items-center justify-center py-16 text-center">
									...
									<p className="mt-3 max-w-sm text-sm leading-relaxed text-ink-soft">
										Thanks for reaching out. A Devonyx specialist will contact
										you within 24 hours at the email you provided.
									</p>
									<button
										type="button"
									...
									<div className="mt-6 grid gap-5 sm:grid-cols-2">
										...
										<div>
											...
											<input
												...
												required
												type="text"
												placeholder="USA / UAE / NL / NZ / India…"
