					...
					<Reveal delay={150}>
						...
						>
							...
							<p className="mt-1 text-sm text-ink-muted">
								Your application is sent securely & we'll get back to you
								shortly.
							</p>
							...
							<div className="mt-6 grid gap-5">
								<div>
									...
									<select
										...
										className="w-full rounded-xl border border-hairline bg-white px-4 py-3 text-sm text-ink shadow-xs outline-hidden transition-colors focus:border-brand focus:ring-2 focus:ring-brand/15"
									>
										{roles.map((r) => (
											<option
												key={r.title}
							...
							{submitted && (
								<div className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-5 text-center">
									<h4 className="font-display text-lg font-medium text-emerald-800">
										Application sent!
									</h4>
