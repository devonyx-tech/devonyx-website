				...
				switch (block.type) {
					...
					case "heading_1":
						return (
							<h2
								key={block.id}
								className="font-display text-2xl font-medium mt-6 mb-2 text-ink"
							>
								<RichText
					...
					case "heading_2":
						return (
							<h3
								key={block.id}
								className="font-display text-xl font-medium mt-5 mb-2 text-ink"
							>
								<RichText
					...
					case "heading_3":
						return (
							<h4
								key={block.id}
								className="font-display text-lg font-medium mt-4 mb-2 text-ink"
							>
								<RichText
					...
					case "quote":
						return (
							<blockquote
								key={block.id}
								className="border-l-3 border-brand pl-4 italic my-4 text-ink"
							>
					...
					case "code":
						return (
							<pre
								key={block.id}
								className="bg-ink-gradient rounded-xl p-4 overflow-x-auto my-4"
							>
					...
					case "callout":
						return (
							<div
								key={block.id}
								className="notion-callout bg-brand/10 border border-brand/20 rounded-xl p-4 my-4"
							>
								<RichText
						...
						return (
							<figure key={block.id} className="my-6">
								<img
									...
									loading="lazy"
									className="rounded-xl border border-hairline w-full"
								/>
